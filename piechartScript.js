...
fundraid = { "Company":"FundRaid Inc.", "Position":"Web Developer", "Time":"Dec'11","Location":"Kitchener, ON","Tasks": tasks = ['Web Dev. on Official Website','Debugging'], "WorkDistribution": workDis = ['75%','25%'], "Color": colors = ['00B0EA','44Da61','00B0EA'], "qTipID": id = ['work_fundraid_1','work_fundraid_2']};
