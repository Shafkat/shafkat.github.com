...
function pieChart() {
  ...
  function startPullOut ( slice ) {
    ...
    $('#chartData2 td').removeClass('highlight');
    var labelCell = $('#chartData2 td:eq(' (slice*2) + ')');
    var valueCell = $('#chartData2 td:eq(' + (slice*2+1) + ')');
